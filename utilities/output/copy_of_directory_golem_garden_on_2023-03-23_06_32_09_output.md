# Copy of directory: golem_garden on 2023-03-23_06_32_09
Configurations: self.excuded_directories: ['__pycache__', 'venv', '.venv', 'build', 'dist', 'golem_garden.egg-info', 'utilities', 'notes', 'experimental', 'docs', 'tests'], self.included_file_types: ['.py', '.txt', '.md', '.html', '.css', '.js', '.json', '.yaml', '.yml'] 
